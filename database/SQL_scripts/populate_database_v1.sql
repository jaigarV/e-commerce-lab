...
INSERT INTO `ecommerce_database`.`PRODUCT` (`ProductID`, `Name`, `Price`, `Quantity`, `DescriptionText`, `DescriptionImage`, `Seller`) VALUES ('', 'Cheese', '5', '10', 'Just cheddar', LOAD_FILE('/var/lib/mysql-files/test_image.jpg'), '11223344');

INSERT INTO `ecommerce_database`.`SHOPPING CART` (`Shopping_cartID`, `Buyer`) VALUES ('', '123456789');
