...
INSERT INTO `ecommerce_database`.`CUSTOMER` (`IdentityNumber`, `Name`, `Password`, `Email`, `Phone`, `Address`, `Gender`, `Age`, `Country`) VALUES ('999999999', 'TestCutomer2', 'test', 'TestCutomer2@test.com', '654321', 'Test Street, Number 2, 000 00, Lulea', 'Other', '200', 'Space');
